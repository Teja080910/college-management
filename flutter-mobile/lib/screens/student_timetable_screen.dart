  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const Text('My Timetable', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: Color(0xFF1e293b))),
          const SizedBox(height: 4),
          const Text('Your weekly class schedule', style: TextStyle(fontSize: 14, color: Color(0xFF64748b))),
