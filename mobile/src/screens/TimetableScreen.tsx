...
import { defaultTimetable } from '../utils/store'
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#f8fafc' }}>
      <ScrollView contentContainerStyle={{ paddingTop: insets.top + 16, padding: 16, paddingBottom: insets.bottom + 24 }}>
        ...
        <Text style={{ fontSize: 14, color: '#64748b', marginBottom: 16 }}>Weekly class schedule</Text>
        ...
        {defaultTimetable.map(day => {
          const colors = DAY_COLORS[day.day] || DAY_COLORS.Monday
          const isToday = day.day === todayName
          return (
            <Card key={day.day} style={{ backgroundColor: '#ffffff', borderRadius: 16, marginBottom: 12, borderWidth: isToday ? 1 : 0, borderColor: '#6366f1' }} elevation={isToday ? 3 : 1}>
              <Card.Content>
