...
const NAV_ITEMS = [
  ...
  { label: 'My Timetable', path: '/my-timetable', icon: Calendar },
  { label: 'My Fees', path: '/my-fees', icon: Banknote },
  { label: 'My Tests', path: '/my-tests', icon: ClipboardList },
]

export default function AppSidebarStudent({ user, onLogout }: { user: { name?: string; username?: string } | null; onLogout: () => void }) {
      ...
      <SidebarHeader className="px-4 py-5">
        <div className="flex items-center gap-3">
          ...
          <div className="group-data-[collapsible=icon]:hidden">
            <p className="text-sm font-semibold tracking-tight">{user?.name || 'Student'}</p>
